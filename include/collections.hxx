...
/**
* @brief 
* Spécialisation du modèle TypeCollection pour std::set.
...
/**
* @brief 
* Spécialisation du modèle TypeCollection pour std::list.
...
/**
* @brief 
* Spécialisation du modèle TypeCollection pour std::deque.
...
/**
* @brief 
* Spécialisation du modèle TypeCollection pour std::vector.
