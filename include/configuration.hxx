...
/**
* @brief 
* Énumération représentant les différentes conditions limites 
...
/**
* @brief 
* Classe représentant la configuration avec laquelle la simulation sera exécuté. 
*/
...
class Configuration{
    ...
    private:
        ...
        /**
        * @brief 
        * Constructeur privé par défaut de la classe Configuration.
        */
        ...
        /**
        * @brief 
        * Constructeur de copie supprimé pour éviter la copie d'instances.
        ...
        */
        ...
        /**
        * @brief 
        * Constructeur de déplacement supprimé pour éviter le transfert d'instances.
        ...
        */
        ...
        /**
        * @brief 
        * Opérateur d'assignation supprimé pour éviter l'assignation d'instances.
    ...
    public:
        ...
        /**
        * @brief 
        * Fonction statique pour accéder à l'unique instance de
        * Configuration.
        */
        ...
        /**
        * @brief 
        * Fonction qui lit les paramètres fournis par l'utilisateur
        ...
        */
        ...
        /**
        * @brief 
        * Fonction qui affiche sur la console les paramètres choisis
        ...
        */
        ...
        /**
        * @brief 
        * Fonction qui affiche sur la console la variété de
        * paramètres que l'utilisateur peut définir dans le
        ...
        */
        ...
        /**
        * @brief 
        * Fonction qui indique si la force de 
        * Lennard-Jones sera utilisée dans la simulation.
        * @return True si la force de Lennard-Jones est utilisée,
        * False sinon.
        */
        ...
        /**
        * @brief 
        * Fonction qui indique si la force d'interaction 
        * gravitationnelle sera utilisée dans la simulation.
        * @return True si la force d'interaction gravitationnelle
        * est utilisée, False sinon.
        */
        ...
        /**
        * @brief 
        * Fonction qui indique si la force du potenciel
        * gravitationnel sera utilisée dans la simulation.
        * @return True si la force du potenciel gravitationnel
        * est utilisée, False sinon.
        */
        ...
        /**
        * @brief 
        * Fonction qui obtient la longueur caractéristique sur l'axe X.
        ...
        */
        ...
        /**
        * @brief 
        * Fonction qui obtient la longueur caractéristique sur l'axe Y.
        ...
        */
        ...
        /**
        * @brief 
        * Fonction qui obtient la longueur caractéristique sur l'axe Z.
        ...
        * @brief 
        * Fonction qui obtient le rayon de
        * coupure pour les réflexions aux bords.
        ...
        */
        ...
        /**
        * @brief 
        * Fonction qui obtient le type de condition limite appliqué
        * aux particules aux limites de l'univers.
        ...
        */
        ...
        /**
        * @brief 
        * Fonction qui indique si la limitation de vitesse sera 
        * appliquée pour maintenir l'énergie cinétique du système.
        ...
        */
        ...
        /**
        * @brief 
        * Fonction qui indique l'énergie désirée
        * en cas de limitation de vitesse activée.
        ...
        */
        ...
        /**
        * @brief 
        * Fonction qui obtient la valeur d'epsilon utilisée
        ...
        */
        ...
        /**
        * @brief 
        * Fonction qui obtient la valeur de sigma utilisée
        *  dans le calcul des forces.
        ...
        */
        ...
        /**
        * @brief 
        * Fonction qui obtient la valeur de G utilisée dans
        ...
        */
        ...
        /**
        * @brief 
        * Function qui obtient la valeur delta par laquelle
        * le temps de simulation avance.
        ...
        */
        ...
        /**
        * @brief 
        * Fonction qui obtient la valeur finale du temps jusqu'à
        * laquelle la simulation sera exécutée.
        ...
        */
        ...
        /**
        * @brief 
        * Fonction qui obtient le chemin du fichier d'entrée où
        * sont stockées les particules à utiliser pour la simulation.
        ...
        */
        ...
        /**
        * @brief 
        * Fonction qui obtient le nom du dossier dans lequel 
        ...
        */
        ...
        /**
        * @brief 
        * Fonction qui permet de modifier la configuration pour
        * les longueurs caractéristiques de l'univers.
        */
        ...
        */
        ...
        void setForces(bool newForceLJ, bool newForceIG, bool newForcePG);

        /**
        * @brief 
        * Fonction qui permet de modifier la configuration de la
        * condition limite appliquée aux bords de l'univers.
        */
        ...
        /**
        * @brief 
        * Fonction qui permet de changer la configuration du rayon
        ...
        */
        ...
        /**
        * @brief
        * Fonction qui permet de modifier la configuration de delta.
        */
